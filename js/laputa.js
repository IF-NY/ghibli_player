...
$(function () {
    ...
    // ===== List 생성하기 =====
    addItem('Carrying You', './musics/20104917.jpg', './musics/라퓨타 Carrying You.mp3');
    addItem('Attack', './musics/20104917.jpg', './musics/라퓨타 Attack.mp3');
    addItem('The Girl Who Fell from the Sky', './musics/20104917.jpg', './musics/라퓨타 The Girl Who Fell from the Sky.mp3');
    addItem('The Eternal Tree of Life', './musics/20104917.jpg', './musics/라퓨타 The Eternal Tree of Life.mp3');
...
function setPlayer(index) {
    ...
    if (title == 'Carrying You') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/46/a0/fa/46a0faec2ba75ac29edf63d8f11968b8.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/46/a0/fa/46a0faec2ba75ac29edf63d8f11968b8.gif")');
        ...
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/a7/77/23/a777230f2aba6c1312eb3b3eb01ca0cd.gif")');
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/a7/77/23/a777230f2aba6c1312eb3b3eb01ca0cd.gif")');
        ...
        $('.item-title').eq(2).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'The Girl Who Fell from the Sky') {
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/17/91/ab/1791ab3a0b68b155ef83706011e79492.gif")');
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/17/91/ab/1791ab3a0b68b155ef83706011e79492.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        ...
        $('.item-title').eq(0).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'The Eternal Tree of Life') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/65/ea/79/65ea7978b411c32fcd546c10bf16b30d.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/65/ea/79/65ea7978b411c32fcd546c10bf16b30d.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        $('.item-title').eq(2).css('color','#888');
