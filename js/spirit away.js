...
$(function () {
    ...
    // ===== List 생성하기 =====
    addItem('Always With Me', './musics/20104917.jpg', './musics/센과 치히로 Always With Me.mp3');
    addItem('One Summers Day', './musics/20104917.jpg', './musics/센과 치히로 One Summers Day.mp3');
    addItem('The Dragon Boy', './musics/20104917.jpg', './musics/센과 치히로 The Dragon Boy.mp3');
    addItem('The Sixth Station', './musics/20104917.jpg', './musics/센과 치히로 The Sixth Station.mp3');
...
function setPlayer(index) {
    ...
    if (title == 'Always With Me') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/82/cf/43/82cf437b13567c088c5e7de051bedf0a.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/82/cf/43/82cf437b13567c088c5e7de051bedf0a.gif")');
    ...
    } else if (title == 'One Summers Day') {
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/ee/c2/bf/eec2bfcd13313eddad554948439722b2.gif")');
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/ee/c2/bf/eec2bfcd13313eddad554948439722b2.gif")');
        ...
        $('.item-title').eq(2).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'The Dragon Boy') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/9e/04/57/9e0457226c24fa58348b29908e471abf.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/9e/04/57/9e0457226c24fa58348b29908e471abf.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        ...
        $('.item-title').eq(0).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'The Sixth Station') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/65/5b/62/655b62d29fe96be72de693ef61574800.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/65/5b/62/655b62d29fe96be72de693ef61574800.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        $('.item-title').eq(2).css('color','#888');
...
$(function(){
   ...
   //         if (title == 'Always With Me') {
  //              $('.playpause').css('background-image','url("https://i.postimg.cc/43ZvGzMF/Frame-18.png")')
