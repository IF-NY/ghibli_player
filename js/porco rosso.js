...
$(function () {
    ...
    // ===== List 생성하기 =====
    addItem('The Bygone Days', './musics/20104917.jpg', './musics/붉은돼지 The Bygone Days.mp3');
    addItem('MADNESS', './musics/20104917.jpg', './musics/붉은 돼지 MADNESS.mp3');
    addItem('Once in a while,Talk of the old days', './musics/20104917.jpg', './musics/붉은 돼지 Once in a while,Talk of the old days.mp3');
    addItem('The Theme of Marco and Gina', './musics/20104917.jpg', './musics/붉은 돼지 The Theme of Marco and Gina.mp3');
...
function setPlayer(index) {
    ...
    if (title == 'The Bygone Days') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/64/ab/81/64ab8133da6cd0cfa6abcf2a249d5e5e.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/64/ab/81/64ab8133da6cd0cfa6abcf2a249d5e5e.gif")');
    ...
    } else if (title == 'MADNESS') {
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/08/91/0b/08910b8ba3d82ef4f13adeb04a95c5fc.gif")');
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/08/91/0b/08910b8ba3d82ef4f13adeb04a95c5fc.gif")');
        ...
        $('.item-title').eq(2).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'Once in a while,Talk of the old days') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/0d/de/8e/0dde8e7b3a70d9515c124fb30212399f.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/0d/de/8e/0dde8e7b3a70d9515c124fb30212399f.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        ...
        $('.item-title').eq(0).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'The Theme of Marco and Gina') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/83/92/38/8392382b675a85872b85f0b01f619da2.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/83/92/38/8392382b675a85872b85f0b01f619da2.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        $('.item-title').eq(2).css('color','#888');
