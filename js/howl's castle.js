...
$(function () {
    ...
    // ===== List 생성하기 =====
    addItem('Merry go round of life', './musics/20104917.jpg', './musics/하울 Merry go round of life.mp3');
    addItem('Promise of the world', './musics/20104917.jpg', './musics/하울 Promise of the world.mp3');
    addItem('Cave Of Mind', './musics/20104917.jpg', './musics/하울 Cave Of Mind.mp3');
    addItem('Sophies Tomorrow', './musics/20104917.jpg', './musics/하울 Sophies Tomorrow.mp3');
...
function addItem(title, image, audio) {
    ...
    //newItem.find('.item-title').html('<img src="https://i.postimg.cc/Bb1pGwyw/Subtract.png"/>'+ title);
...
function setPlayer(index) {
    ...
    if (title == 'Merry go round of life') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/a8/01/8e/a8018e6075ce9d3ecded31c2b9523d9d.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/a8/01/8e/a8018e6075ce9d3ecded31c2b9523d9d.gif")');
    ...
    } else if (title == 'Promise of the world') {
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/38/4d/54/384d5499ac485858e7d3dbaa1c6baadc.gif")');
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/38/4d/54/384d5499ac485858e7d3dbaa1c6baadc.gif")');
        ...
        $('.item-title').eq(2).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'Cave Of Mind') {
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://64.media.tumblr.com/1ad6653493023a5267b5af650b4b3794/tumblr_nsoza5VKWo1qlr8pbo1_500.gifv")');
        $('.circle_1').css('background-image', 'url("https://64.media.tumblr.com/1ad6653493023a5267b5af650b4b3794/tumblr_nsoza5VKWo1qlr8pbo1_500.gifv")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        ...
        $('.item-title').eq(0).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'Sophies Tomorrow') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/c4/9e/73/c49e73a0b3c9b1e5cf3820579d2751e8.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/c4/9e/73/c49e73a0b3c9b1e5cf3820579d2751e8.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        $('.item-title').eq(2).css('color','#888');
