...
$(function () {
    ...
    // ===== List 생성하기 =====
    addItem('Deep Sea Ranch', './musics/20104917.jpg', './musics/포뇨 Deep Sea Ranch.mp3');
    addItem('Mother Sea', './musics/20104917.jpg', './musics/포뇨 Mother Sea.mp3');
    addItem('Ponyo on the Cliff', './musics/20104917.jpg', './musics/포뇨 Ponyo on the Cliff.mp3');
    ...
    // $(currentAudio).play();
    // currentPlayer.find('.item-audio')[0].play();
    // paly(currentAudio);
...
function setPlayer(index) {
    ...
    if (title == 'Deep Sea Ranch') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/1f/c3/e8/1fc3e80eaa0d99074934ee0de5cb369c.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/1f/c3/e8/1fc3e80eaa0d99074934ee0de5cb369c.gif")');
    ...
    } else if (title == 'Mother Sea') {
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/19/39/8d/19398d1b2cc00281bacd17e92995d0d0.gif")');
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/19/39/8d/19398d1b2cc00281bacd17e92995d0d0.gif")');
        ...
        $('.item-title').eq(2).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'Ponyo on the Cliff') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/95/2c/f3/952cf3c7fbf9370de3eed6afcc888a1e.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/95/2c/f3/952cf3c7fbf9370de3eed6afcc888a1e.gif")');
