...
$(function () {
  ...
  // ===== List 생성하기 =====
  addItem('A Town With An Ocean View', './musics/20104917.jpg', './musics/A Town With An Ocean View.mp3');
  addItem('On a Clear Day', './musics/20104917.jpg', './musics/On a Clear Day Hareta Hi ni.mp3');
  addItem('The Bakers Assistant', './musics/20104917.jpg', './musics/The Bakers Assistant Panya no Tetsudai.mp3');

  if (params != null) {
    currentPlayer = parseInt(params.get('song'));
  }
  setPlayer(currentPlayer); // 클릭한 곡으로 초기값 설정
...
function setPlayer(index) {
  ...
  if (title == 'A Town With An Ocean View') {
    $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/cd/b8/5b/cdb85bd3cc1df6765f872ac1dd2634a0.gif")');
    $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/cd/b8/5b/cdb85bd3cc1df6765f872ac1dd2634a0.gif")');
  ...
  } else if (title == 'On a Clear Day') {
    $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/3e/9d/68/3e9d681fac274b74cdcaed61d4b117db.gif")');
    $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/3e/9d/68/3e9d681fac274b74cdcaed61d4b117db.gif")');
    $('.item-title').eq(0).css('color','#888');
        ...
        $('.item-title').eq(2).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
  } else if (title == 'The Bakers Assistant') {
    $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/1d/5b/17/1d5b173e40dfc1b066584eeeeb9f2a5f.gif")');
    $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/1d/5b/17/1d5b173e40dfc1b066584eeeeb9f2a5f.gif")');
    $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
