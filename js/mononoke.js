...
$(function () {
    ...
    // ===== List 생성하기 =====
    addItem('Theme of Princess Mononoke', './musics/20104917.jpg', './musics/원령공주 Theme of Princess Mononoke.mp3');
    addItem('Departure to the West', './musics/20104917.jpg', './musics/원령공주 Departure to the West.mp3');
    addItem('Sho song', './musics/20104917.jpg', './musics/원령공주 SHO SONG.mp3');
    addItem('Ashitaka and San Theme', './musics/20104917.jpg', './musics/원령공주  Ashitaka and San Theme.mp3');
...
function setPlayer(index) {
    ...
    if (title == 'Theme of Princess Mononoke') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/b8/29/e8/b829e8460cd9b2e06c4ed454cdefcc7e.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/b8/29/e8/b829e8460cd9b2e06c4ed454cdefcc7e.gif")');
    ...
    } else if (title == 'Departure to the West') {
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/05/11/39/05113927e3ef8442d81506a4b3e1d433.gif")');
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/05/11/39/05113927e3ef8442d81506a4b3e1d433.gif")');
        ...
        $('.item-title').eq(2).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'Sho song') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/ff/45/22/ff452273179d8518fc1250fbf85be95c.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/ff/45/22/ff452273179d8518fc1250fbf85be95c.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        ...
        $('.item-title').eq(0).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
        $('.item-title').eq(3).find('.play-item > .playpause').css('background-image','url("https://i.postimg.cc/fyqzq07J/Frame-18.png")');
    } else if (title == 'Ashitaka and San Theme') {
        $('.circle_1').css('background-image', 'url("https://i.pinimg.com/originals/c3/5f/e4/c35fe4c0fb2a321fa257c0366f1fefdc.gif")');
        $('.dark').css('background-image', 'linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ),url("https://i.pinimg.com/originals/c3/5f/e4/c35fe4c0fb2a321fa257c0366f1fefdc.gif")');
        $('.item-title').eq(0).css('color','#888');
        $('.item-title').eq(1).css('color','#888');
        $('.item-title').eq(2).css('color','#888');
